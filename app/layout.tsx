  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`}>
      <body className="min-h-full flex flex-col bg-white text-slate-900">
        ...
        {/* Velocity AI 24/7 Chatbot - Top Right - Fixed Readability */}
        <script
              ...
              document.addEventListener('DOMContentLoaded', function() {
                const html = \`
                  <div id="velocity-chatbot" style="position:fixed; top:20px; right:20px; z-index:9999;">
                    <div id="chat-minimized" onclick="toggleVelocityChat()" style="padding:16px 24px; background:#0a0a0a; border:2px solid #00d4ff; border-radius:9999px; cursor:pointer; display:flex; align-items:center; gap:12px; box-shadow:0 10px 30px rgba(0,0,0,0.5);">
                    ...
                    <div id="chat-full" style="display:none; width:380px; background:#112233; border:2px solid #00d4ff; border-radius:20px; box-shadow:0 15px 40px rgba(0,0,0,0.6); overflow:hidden;">
                      ...
                      <div id="chat-messages" style="height:340px; overflow-y:auto; padding:20px; background:#1f2a44; color:#e0f0ff; line-height:1.55; font-size:15.5px;"></div>
